...
const EXPERIMENT_CONFIG = {
  ...
  stories: [
    ...
    // ---- 故事5：美术课 ----
    {
      ...
      questionAudioCount: 9,
      transitionText: '今天下午第二节是美术课，老师走进教室说："同学们，今天我们来画《我的植物朋友》，画完之后一起贴在黑板报上展示，大家拿出自己的画笔开始画。"大家纷纷翻开书包掏画笔。你刚把自己的彩笔摆好，余光瞥见旁边的小诺——她把书包翻了个底朝天，脑袋都快埋进书包里了，手指一直抠着书包带子，嘴巴抿得紧紧的。',
      voiceQuestion: '请用语音回答：在刚才的情景中，您做出选择的主要原因是什么？',
      questions: [
        {
          id: 'q1',
          stem: '看到小诺这样，你心里怎么想？',
          options: [
            { value: 'A', label: '她在干什么，怎么还不开始画呀？' },
            { value: 'B', label: '她好像挺着急的，是不是忘记带画笔了？' },
            { value: 'C', label: '她估计是没带画笔，着急又不好意思开口问吧。' },
          ],
        },
        {
          id: 'q2',
          stem: '小诺一直低着头，偷偷瞄旁边的同学，嘴巴动了动又没出声。你会怎么做？',
          options: [
            { value: 'A', label: '不管她，我先画好自己的就行。' },
            { value: 'B', label: '感觉她需要帮忙，但还是等她先问我吧，继续画自己的。' },
            { value: 'C', label: '怕小诺不好意思，于是主动问："你是不是遇到什么麻烦了？"' },
          ],
        },
        {
          id: 'q3',
          stem: '小诺犹豫了一下，对着你小声说："我好像把画笔忘在家里了……"。你轻轻把画笔往她那边推了推，小诺没有马上接。她小声地问了一句："那……你自己够用吗？"你怎么回应她？',
          options: [
            { value: 'A', label: '"你自己先快点开始画吧，要来不及了。"' },
            { value: 'B', label: '"你先拿着用，别担心我。"' },
            { value: 'C', label: '"不用担心，我们可以换着用。"' },
          ],
        },
        {
          id: 'q4',
          stem: '小诺握着笔，视线悄悄扫过旁边其他人的画纸，声音轻轻的："大家都画好一阵子了，就我耽搁了这么久，跟不上大家了。"你怎么说？',
          options: [
            { value: 'A', label: '"那就别抱怨了，快抓紧动笔画吧。"' },
            { value: 'B', label: '"别急，你画得快，来得及的。"' },
            { value: 'C', label: '"现在画也不晚呀，不着急，有我陪你一起。"' },
          ],
        },
        {
          id: 'q5',
          stem: '快要画完的时候，小诺正欣赏着自己的画。这时旁边的同学起身交作业，胳膊不小心蹭到她的画纸。画笔在画上"呲"地划了一道长长的线。小诺愣住了，整个人僵在那里，她盯着那道多余的线，眼眶一下子就红了，什么话也没说。你心里怎么想？',
          options: [
            { value: 'A', label: '那个人怎么这么不小心啊，把别人的画都毁了。' },
            { value: 'B', label: '小诺真倒霉，她好不容易才画完的。' },
            { value: 'C', label: '她这么努力才画好，一下子被划了，肯定特别难过。' },
          ],
        },
        {
          id: 'q6',
          stem: '小诺拿着画，声音有点抖："我画了好久……现在多了一道线，整张画都毁了……"你怎么说？',
          options: [
            { value: 'A', label: '"那怎么办啊，要不你再重画一张？"' },
            { value: 'B', label: '"别太难过了，没事的。"' },
            { value: 'C', label: '"画了那么久后被划了，我看着都难受。"' },
          ],
        },
        {
          id: 'q7',
          stem: '小诺低头看着那道多余的线，小声说："我觉得自己好倒霉，每次都是我遇到这种事。"你怎么说？',
          options: [
            { value: 'A', label: '"运气不好，碰上了也是没办法。"' },
            { value: 'B', label: '"别放心上了，倒霉的事谁都会碰到。"' },
            { value: 'C', label: '"我上次做手工快做完的时候被人碰坏了，也觉得好倒霉。"' },
          ],
        },
        {
          id: 'q8',
          stem: '小诺拿着画翻来覆去地看，犹豫地说："这道线这么明显，展示的时候大家肯定会注意到……"她的声音越来越小，手不自觉地想把画折起来。你怎么说？',
          options: [
            { value: 'A', label: '"画都画了，你就交呗。"' },
            { value: 'B', label: '"其实也没有很明显啦，你别太在意。"' },
            { value: 'C', label: '"大家看的是整幅画，我觉得你画得挺好。"' },
          ],
        },
        {
          id: 'q9',
          stem: '小诺拿着画，站在座位旁边犹豫，不知道该怎么办。你怎么做？',
          options: [
            { value: 'A', label: '"你再犹豫就下课了，赶紧交吧"，边说边推着小诺去交画。' },
            { value: 'B', label: '拍拍小诺，"我们跟老师解释一下就可以了。"' },
            { value: 'C', label: '仔细看了小诺的画，"你看，这道线可以改成一个小装饰，我陪你改，改完一起去交。"' },
          ],
        },
      ],
    },
